...
//        String user_name = input.next();
        String user_name = JOptionPane.showInputDialog(null, "Enter your name");
...
//                System.out.println("Player: " + players.getName());
    ...
    private void setTable() {
        ...
        getTable().add(0, teamOnePlayerOne);
        getTable().add(1, teamTwoPlayerOne);
        getTable().add(2, teamOnePlayerTwo);
        getTable().add(3, teamTwoPlayerTwo);
        
        //select the first dealer
        Random random = new Random();
        dealerIdx = random.nextInt(Constants.NUM_PLAYERS);
        dealer = getTable().get(dealerIdx);
        
//        System.out.println("Players at the table are");
        for(Player player : getTable()) {
...
//           System.out.println("Adding to player " + table.get(playerIdx).getName() + " hand");
            getTable().get(playerIdx).getHand().add(card);
...
//        System.out.println("*****");
    ...
    private void getBids() {
        ...
        leadPlayer = getTable().get(leadIdx);
...
//        System.out.println("Lead player is player " + leadPlayer.getName());
        ...
        Player nextPlayer = getTable().get(playerIdx);
...
//            System.out.println("Getting bid from player " + nextPlayer.getName());
            ...
            nextPlayer = getTable().get(playerIdx);
        }
    }
